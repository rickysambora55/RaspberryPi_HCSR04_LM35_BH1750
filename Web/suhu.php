        ...
        <div class="row">
            ...
            <main class="col-md-8 ms-sm-auto col-lg-9 px-md-4 bg-body-tertiary ">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Log Sensor Suhu</h1>
                </div>
                            ...
                            <table id="tabeldata" class="table table-striped table-hover my-3 text-center">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="text-center text-dark-emphasis">Suhu (C)</th>
                                    </tr>
                                </thead>
                                <tbody class="table-group-divider">
                                    <?php
                                    include "assets/database/koneksi.php";
                                    $result = mysqli_query($db, "SELECT * FROM sensorSuhu ORDER BY id");
...
<script type="text/javascript">
    const sensorData = <?php
                        ...
                        $result = mysqli_query($db, "SELECT timestamp, suhu FROM sensorSuhu ORDER BY id DESC LIMIT 10");
    ...
    const valueArray = sensorData.suhu;
